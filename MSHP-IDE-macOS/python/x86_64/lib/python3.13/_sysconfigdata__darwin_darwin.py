...
build_time_vars = {
    ...
    "AR": "/var/folders/lf/wbx6llps6z37wkfpk85_942m0000gn/T/tmpfevsrc6i/tools/llvm/bin/llvm-ar",
    "ARFLAGS": "rcs",
    ...
    "BLDSHARED": "clang -pthread -bundle -undefined dynamic_lookup -arch x86_64 -mmacosx-version-min=10.15   -LModules/_hacl -Wl,-headerpad,40",
    "BOOTSTRAP_HEADERS": "\\",
    "BUILDEXE": ".exe",
    ...
    "CONFIGURE_LDFLAGS": "-arch x86_64 -mmacosx-version-min=10.15   -LModules/_hacl -Wl,-headerpad,40",
    "CONFIGURE_LDFLAGS_NODIST": "-flto=thin -Wl,-export_dynamic -Wl,-object_path_lto,\"$@\".lto -g",
    "CONFIGURE_LDFLAGS_NOLTO": "-flto=thin",
    "CONFIG_ARGS": "'--build=aarch64-apple-darwin' '--host=x86_64-apple-darwin' '--prefix=/install' '--with-openssl=/var/folders/lf/wbx6llps6z37wkfpk85_942m0000gn/T/tmpfevsrc6i/tools/deps' '--with-system-expat' '--with-system-libmpdec' '--without-ensurepip' '--enable-shared' '--with-mimalloc' '--enable-optimizations' '--with-lto' '--with-build-python=/var/folders/lf/wbx6llps6z37wkfpk85_942m0000gn/T/tmpfevsrc6i/tools/host/bin/python3.13' 'ac_cv_lib_intl_textdomain=no' 'MACHDEP=darwin' 'ac_sys_system=Darwin' 'ac_sys_release=24.6.0' 'ac_cv_func_ptsname_r=no' '--with-dbmliborder=ndbm' 'cross_compiling=yes' 'ac_cv_buggy_getaddrinfo=no' 'ac_cv_file__dev_ptc=no' 'ac_cv_file__dev_ptmx=no' 'ac_cv_pthread=yes' 'ac_cv_aligned_required=no' 'build_alias=aarch64-apple-darwin' 'host_alias=x86_64-apple-darwin' 'PKG_CONFIG=pkg-config --static' 'PKG_CONFIG_PATH=/var/folders/lf/wbx6llps6z37wkfpk85_942m0000gn/T/tmpfevsrc6i/tools/deps/share/pkgconfig:/var/folders/lf/wbx6llps6z37wkfpk85_942m0000gn/T/tmpfevsrc6i/tools/deps/lib/pkgconfig' 'CC=clang' 'CFLAGS=-O3 -arch x86_64 -mmacosx-version-min=10.15 -Wno-nullability-completeness -Wno-expansion-to-defined -Wno-undef-prefix   -fPIC    -Werror=unguarded-availability-new' 'LDFLAGS=-arch x86_64 -mmacosx-version-min=10.15   -LModules/_hacl -Wl,-headerpad,40' 'CPPFLAGS=-O3 -arch x86_64 -mmacosx-version-min=10.15 -Wno-nullability-completeness -Wno-expansion-to-defined -Wno-undef-prefix   -fPIC    -Werror=unguarded-availability-new' 'PROFILE_TASK=-m test --pgo'",
    "CONFINCLUDEDIR": "/install/include",
    "CONFINCLUDEPY": "/install/include/python3.13",
    "COREPYTHONPATH": "",
    "COVERAGE_INFO": "/private/var/folders/lf/wbx6llps6z37wkfpk85_942m0000gn/T/tmpfevsrc6i/Python-3.13.10/coverage.info",
    "COVERAGE_LCOV_OPTIONS": "--rc lcov_branch_coverage=1",
    "COVERAGE_REPORT": "/private/var/folders/lf/wbx6llps6z37wkfpk85_942m0000gn/T/tmpfevsrc6i/Python-3.13.10/lcov-report",
    ...
    "FILEMODE": 644,
    "FREEZE_MODULE": "/var/folders/lf/wbx6llps6z37wkfpk85_942m0000gn/T/tmpfevsrc6i/tools/host/bin/python3.13 ./Programs/_freeze_module.py",
    "FREEZE_MODULE_BOOTSTRAP": "/var/folders/lf/wbx6llps6z37wkfpk85_942m0000gn/T/tmpfevsrc6i/tools/host/bin/python3.13 ./Programs/_freeze_module.py",
    ...
    "JIT_DEPS": "\\",
    "LDCXXSHARED": "clang++ -bundle -undefined dynamic_lookup -arch x86_64 -mmacosx-version-min=10.15   -LModules/_hacl -Wl,-headerpad,40",
    "LDFLAGS": "-arch x86_64 -mmacosx-version-min=10.15   -LModules/_hacl -Wl,-headerpad,40",
    "LDLIBRARY": "libpython3.13.dylib",
    "LDLIBRARYDIR": "",
    "LDSHARED": "clang -pthread -bundle -undefined dynamic_lookup -arch x86_64 -mmacosx-version-min=10.15   -LModules/_hacl -Wl,-headerpad,40",
    "LDVERSION": "3.13",
    "LIBC": "",
    "LIBDEST": "/install/lib/python3.13",
    "LIBDIR": "/install/lib",
    "LIBEXPAT_A": "Modules/expat/libexpat.a",
    "LIBEXPAT_CFLAGS": "-fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -O3 -arch x86_64 -mmacosx-version-min=10.15 -Wno-nullability-completeness -Wno-expansion-to-defined -Wno-undef-prefix   -fPIC    -Werror=unguarded-availability-new -flto=thin -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden -fprofile-instr-use=/private/var/folders/lf/wbx6llps6z37wkfpk85_942m0000gn/T/tmpfevsrc6i/Python-3.13.10/code.profclangd -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -O3 -arch x86_64 -mmacosx-version-min=10.15 -Wno-nullability-completeness -Wno-expansion-to-defined -Wno-undef-prefix   -fPIC    -Werror=unguarded-availability-new",
    "LIBEXPAT_HEADERS": "\\",
    "LIBEXPAT_OBJS": "\\",
    ...
    "LLVM_PROF_MERGER": "/var/folders/lf/wbx6llps6z37wkfpk85_942m0000gn/T/tmpfevsrc6i/tools/llvm/bin/llvm-profdata merge -output=\"$(shell pwd)/code.profclangd\" \"$(shell pwd)\"/*.profclangr",
    "LN": "ln",
    ...
    "PYTHONPATH": "",
    "PYTHON_FOR_BUILD": "_PYTHON_PROJECT_BASE=/private/var/folders/lf/wbx6llps6z37wkfpk85_942m0000gn/T/tmpfevsrc6i/Python-3.13.10 _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=./Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__darwin_darwin _PYTHON_SYSCONFIGDATA_PATH=$(shell test -f pybuilddir.txt && echo /private/var/folders/lf/wbx6llps6z37wkfpk85_942m0000gn/T/tmpfevsrc6i/Python-3.13.10/`cat pybuilddir.txt`) /var/folders/lf/wbx6llps6z37wkfpk85_942m0000gn/T/tmpfevsrc6i/tools/host/bin/python3.13",
    "PYTHON_FOR_BUILD_DEPS": "",
    "PYTHON_FOR_FREEZE": "/var/folders/lf/wbx6llps6z37wkfpk85_942m0000gn/T/tmpfevsrc6i/tools/host/bin/python3.13",
    "PYTHON_FOR_REGEN": "",
    "PYTHON_HEADERS": "\\",
    "PYTHON_OBJS": "\\",
    ...
    "PY_CORE_LDFLAGS": "-arch x86_64 -mmacosx-version-min=10.15   -LModules/_hacl -Wl,-headerpad,40 -flto=thin -Wl,-export_dynamic -Wl,-object_path_lto,\"$@\".lto -g",
    ...
    "PY_LDFLAGS": "-arch x86_64 -mmacosx-version-min=10.15   -LModules/_hacl -Wl,-headerpad,40",
    "PY_LDFLAGS_NODIST": "-flto=thin -Wl,-export_dynamic -Wl,-object_path_lto,\"$@\".lto -g",
    "PY_LDFLAGS_NOLTO": "-arch x86_64 -mmacosx-version-min=10.15   -LModules/_hacl -Wl,-headerpad,40 -flto=thin",
    ...
    "RESSRCDIR": "",
    "RETSIGTYPE": "void",
    "RUNSHARED": "DYLD_LIBRARY_PATH=/private/var/folders/lf/wbx6llps6z37wkfpk85_942m0000gn/T/tmpfevsrc6i/Python-3.13.10",
    ...
    "TESTOPTS": "",
    "TESTPATH": "",
    "TESTPYTHON": "DYLD_LIBRARY_PATH=/private/var/folders/lf/wbx6llps6z37wkfpk85_942m0000gn/T/tmpfevsrc6i/Python-3.13.10 _PYTHON_PROJECT_BASE=/private/var/folders/lf/wbx6llps6z37wkfpk85_942m0000gn/T/tmpfevsrc6i/Python-3.13.10 _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=./Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__darwin_darwin _PYTHON_SYSCONFIGDATA_PATH=$(shell test -f pybuilddir.txt && echo /private/var/folders/lf/wbx6llps6z37wkfpk85_942m0000gn/T/tmpfevsrc6i/Python-3.13.10/`cat pybuilddir.txt`) /var/folders/lf/wbx6llps6z37wkfpk85_942m0000gn/T/tmpfevsrc6i/tools/host/bin/python3.13",
    "TESTPYTHONOPTS": "",
    "TESTRUNNER": "DYLD_LIBRARY_PATH=/private/var/folders/lf/wbx6llps6z37wkfpk85_942m0000gn/T/tmpfevsrc6i/Python-3.13.10 _PYTHON_PROJECT_BASE=/private/var/folders/lf/wbx6llps6z37wkfpk85_942m0000gn/T/tmpfevsrc6i/Python-3.13.10 _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=./Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__darwin_darwin _PYTHON_SYSCONFIGDATA_PATH=$(shell test -f pybuilddir.txt && echo /private/var/folders/lf/wbx6llps6z37wkfpk85_942m0000gn/T/tmpfevsrc6i/Python-3.13.10/`cat pybuilddir.txt`) /var/folders/lf/wbx6llps6z37wkfpk85_942m0000gn/T/tmpfevsrc6i/tools/host/bin/python3.13 -m test",
    ...
    "abs_builddir": "/private/var/folders/lf/wbx6llps6z37wkfpk85_942m0000gn/T/tmpfevsrc6i/Python-3.13.10",
    "abs_srcdir": "/private/var/folders/lf/wbx6llps6z37wkfpk85_942m0000gn/T/tmpfevsrc6i/Python-3.13.10",
